...
The extension requires the `tokengraph` Python CLI to parse your codebase.

```bash
# Recommended
uv pip install tokengraph

# Alternatives
pipx install tokengraph
...
The graph database is stored locally at `.tokengraph/graph.db` and updates automatically on file save.
...
- [Main Repository](https://github.com/hetansh7722/tokengraph)
- [Report an Issue](https://github.com/hetansh7722/tokengraph/issues)
