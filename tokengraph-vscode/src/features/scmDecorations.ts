 ...
 *  - IMPACTED (orange) â€” file is in the blast radius of staged/unstaged changes
 *  - TESTED (green) â€” changed functions in this file have test coverage
 *  - UNTESTED (red) â€” changed functions lack test coverage
 */
