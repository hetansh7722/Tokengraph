...
def test_export_graph_data(store_with_data):
    from tokengraph.visualization import export_graph_data
...
def test_generate_html(store_with_data, tmp_path):
    from tokengraph.visualization import generate_html
...
def test_cpp_include_resolution(tmp_path):
    ...
    stored under absolute paths â€” previously these were dropped, leaving the
    ...
    # Parser emits bare include paths as targets â€” exactly what Tree-sitter sees
