...
from tokengraph.parser import NodeInfo
from tokengraph.search import (
...
class TestHybridSearch:
    ...
    def test_fallback_to_keyword(self):
        ...
        # Do NOT rebuild FTS index â€” drop it if it exists
        try:
    ...
    def test_fts_query_with_special_chars(self):
        ...
        rebuild_fts_index(self.store)
        # These should not crash â€” FTS5 operators like AND, OR, NOT, *, etc.
