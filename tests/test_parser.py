...
from tokengraph.parser import CodeParser
...
class TestCodeParser:
    ...
    def test_calls_edge_same_file_resolution(self):
        ...
        # create_auth_service() calls AuthService() â€” a class defined in the same file
        auth_service_calls = [
    ...
    def test_calls_edge_decorated_function_resolution(self):
        ...
        # guarded_process() calls process_request() â€” both in the same file,
