...
from tokengraph.eval.reporter import (
...
try:
    ...
    from tokengraph.eval.runner import write_csv
    _HAS_YAML = True
except ImportError:
    _HAS_YAML = False
    write_csv = None  # type: ignore[assignment]
from tokengraph.eval.scorer import (
    compute_mrr,
...
def test_runner_with_mock_repo():
    ...
    with tempfile.TemporaryDirectory() as tmpdir:
        ...
        from tokengraph.incremental import full_build, get_db_path
        ...
        from tokengraph.eval.benchmarks import token_efficiency
        ...
        # Run impact_accuracy
        from tokengraph.eval.benchmarks import impact_accuracy
        ...
        # Run search_quality
        from tokengraph.eval.benchmarks import search_quality
        ...
        from tokengraph.eval.benchmarks import build_performance
