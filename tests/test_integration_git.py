...
from tokengraph.changes import parse_git_diff_ranges
...
from tokengraph.wiki import get_wiki_page
...
def git_repo(tmp_path: Path) -> Path:
    ...
    # Second commit â€” modify the file
    py_file.write_text(
        "def greet():\n    return 'hello'\n\n"
        "def farewell():\n    return 'goodbye'\n"
    )
...
def test_wiki_page_path_traversal_blocked(tmp_path: Path) -> None:
    ...
    # Attempt a path traversal â€” should return None
