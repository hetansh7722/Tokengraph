...
def build_or_update_graph(
    ...
    try:
        ...
        # Rebuild FTS index
        try:
            from tokengraph.search import rebuild_fts_index
        ...
        try:
            from tokengraph.flows import store_flows as _store_flows
            from tokengraph.flows import trace_flows as _trace_flows
