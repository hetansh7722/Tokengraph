...
- The graph is stored as a SQLite database (`.tokengraph/graph.db`) in the repo root
- Binary files, generated files, and patterns in `.tokengraphignore` are skipped
