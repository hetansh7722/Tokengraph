...
# With coverage
uv run pytest --cov=tokengraph --cov-report=term-missing --cov-fail-under=50
...
6. Ensure linting passes: `uv run ruff check tokengraph/`
7. Submit a pull request

## Project Structure

```
tokengraph/     # Core Python package
