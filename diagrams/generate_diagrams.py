...
# â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•
# DIAGRAM 2 â€” Architecture Pipeline
# â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•
def d2():
    els = []
...
def d3():
    ...
    # Ring 1 (depth 1, orange) â€” 3 nodes
    r1 = 200
    ring1_spec = [
    ...
    # Ring 2 (depth 2, yellow) â€” 3 nodes
    r2 = 370
    ring2_spec = [
...
# â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•
# DIAGRAM 4 â€” Incremental Update Flow
# â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•
def d4():
    els = []
...
# â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•
# DIAGRAM 5 â€” Benchmark Metric Board
# â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•
def d5():
    els = []
    ...
    # Footnote â€” styled as a subtle callout
    fn_y = cy + ch + 20
    els.append(LN(x0+80, fn_y, [[0,0],[total-160,0]], sc=GRY, sw=1, op=30))
    els.append(TC(800, fn_y+10, "Reproducible: tokengraph eval --all", 18, sc=GRY))

    return els


# â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•
# DIAGRAM 6 â€” Monorepo Funnel
# â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•
def d6():
    els = []
    els.append(TC(700, 15, "The Monorepo Problem, Solved", 40))

    # â”€â”€ LEFT: dense grid â”€â”€
    gx, gy = 40, 110
    cols, rows = 14, 9
    dw, dh = 20, 16
    gapx, gapy = 26, 22
    ...
    # â”€â”€ CENTER: funnel (rounded rect) â”€â”€
    fx, fy, fw, fh = 470, 120, 210, 180
    els.append(R(fx, fy, fw, fh, bg=PRP_BG, fs="solid", sc=PRP))
    fcx = fx + fw/2
    els.append(TC(fcx, fy+25,  "tokengraph", 17, sc=PRP))
    ...
    # â”€â”€ RIGHT: sparse green files â”€â”€
    rf_x, rf_y = 760, 130
